...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.ryanberg.angrails.security.model.SecUser'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.ryanberg.angrails.security.model.SecUserSecRole'
grails.plugin.springsecurity.authority.className = 'com.ryanberg.angrails.security.model.SecRole'
...
grails.plugin.springsecurity.apf.usernameParameter = '_username'
grails.plugin.springsecurity.apf.passwordParameter = '_password'

grails.plugin.springsecurity.rememberMe.persistent = true
grails.plugin.springsecurity.rememberMe.alwaysRemember = true
grails.plugin.springsecurity.rememberMe.persistentToken.domainClassName = 'com.ryanberg.angrails.security.model.SecPersistentLogin'

grails.plugin.springsecurity.useSessionFixationPrevention = false // for compatibility with session-cookies

grails.plugin.cookiesession.enabled = true
grails.plugin.cookiesession.encryptcookie = true
grails.plugin.cookiesession.cryptoalgorithm = "Blowfish"
grails.plugin.cookiesession.secret = "D0nT73lL4ny0Ne"
